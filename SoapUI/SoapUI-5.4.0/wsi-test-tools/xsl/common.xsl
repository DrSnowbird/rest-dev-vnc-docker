...
<!--
  Common formatting for Testing Tools XML documents.
	...
	Copyright (c) 2002-2007 by The Web Services-Interoperability Organization (WS-I) and 
...
<xsl:template name="copyright">
 <!-- <hr style="color : black;"/>-->
  <p class="copyright" id="copyright">Copyright (c) 2002-2007 by <a href="http://www.ws-i.org/">The Web Services-Interoperability Organization</a> (<abbr title="Web Services Interoperability Organization">WS-I</abbr>) and Certain of its Members. All Rights Reserved.</p>
