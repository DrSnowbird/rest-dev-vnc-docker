...
monitor-config-bsp11.xml is a sample monitor configuration file which you can
...
monitor.bat -config monitor-config-bsp11.xml

---

To use the analyzer tool, run:
analyzerV11.bat -config <configFile>


analyzer-config-bsp11.xml is a sample analyzer configuration file which you can
use right out of the box to analyze the provided sample log file,
log-sample.xml.  The following command will generate a report-bsp11.xml file:

analyzerV11.bat -config analyzer-config-bsp11.xml
